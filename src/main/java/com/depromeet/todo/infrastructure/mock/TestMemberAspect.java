...
public class TestMemberAspect {
    ...
    @Around("execution(* com.depromeet.todo.infrastructure.jwt.JwtApplicationService.decode(String))")
    public Object mockUser(ProceedingJoinPoint pjp) throws Throwable {
        try {
            ...
            if (TEST_MEMBER_ACCESS_TOKEN.equals(token)) {
                return Optional.of(memberApplicationService.getOrCreateMember(KAKAO_ACCESS_TOKEN).getMemberId());
            }
